  ...
  return (
    <section className="flex justify-center items-center flex-col-reverse lg:flex-row gap-20 my-20 lg:my-36 mx-auto w-full">
      <div className="flex flex-col justify-center gap-y-6 md:w-1/2 p-5 md:p-0 ">
        ...
        <button className="bg-[#F98585] p-2 w-52 h-12 text-white font-heebo font-[500px] text-lg rounded-sm hover:bg-customBlue transition-colors duration-300 ease-linear" style={{boxShadow: "0 4px 4px 0 #4141418"}}>Download Resume</button>
      </div>
